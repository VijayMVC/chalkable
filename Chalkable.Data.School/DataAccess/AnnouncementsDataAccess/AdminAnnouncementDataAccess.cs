...
{
    public class AdminAnnouncementDataAccess : BaseAnnouncementDataAccess<AdminAnnouncement>
    {
        ...
        protected virtual DbQuery SelectAdminAnnouncement(int callerId)
        {
            throw new NotImplementedException();
        }
        protected virtual DbQuery FilterAdminAnnouncementByCaller(DbQuery dbQuery, int callerId)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Exists(string title, int? excludeAnnouncementId)
        {
            var conds = new AndQueryCondition {{Announcement.TITLE_FIELD, title}};
