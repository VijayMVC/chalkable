...
namespace Chalkable.Data.School.Model
{
    ...
    public class AnnouncementComplex : Announcement
    {
        ...
        public string AnnouncementTypeName
        {
            get { return IsAdminAnnouncement ? ADMIN_ANNOUNCEMENT_TYPE_NAME : ClassAnnouncementTypeName; }
        }
        ...
        public string DefaultTitle
        {
            get
            {
                return !string.IsNullOrEmpty(ClassAnnouncementTypeName)
                    ...
                    : AdminRef.HasValue ? ADMIN_ANNOUNCEMENT_TYPE_NAME : null;
            }
        }
