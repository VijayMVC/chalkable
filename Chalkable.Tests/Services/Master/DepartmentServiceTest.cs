...
namespace Chalkable.Tests.Services.Master
{
    public class DepartmentServiceTest : MasterServiceTestBase
    {
        ...
        public void AddDeleteDepartmentTest()
        {
            ...
            Assert.AreEqual(SysAdminMasterLocator.DepartmentIconService.GetPicture(department.Id.ToString(), null, null), icon1);
            ...
            Assert.AreEqual(SysAdminMasterLocator.DepartmentIconService.GetPicture(department.Id.ToString(), null, null), icon2);
            AssertAreEqual(department, SysAdminMasterLocator.ChalkableDepartmentService.GetChalkableDepartmentById(department.Id));
            ...
            Assert.IsNull(SysAdminMasterLocator.DepartmentIconService.GetPicture(department.Id.ToString(), null, null));
        }
    }
}
