...
namespace Chalkable.Tests.Services.School
{
    public class AnnouncementServiceTest : BaseSchoolServiceTest
    {
        ...
        public void CreateDeleteDraftAnnouncementTest()
        {
            ...
            var annTypeHw = SchoolTestContext.AdminGradeSl.AnnouncementTypeService.GetAnnouncementTypeBySystemType(
        ...
        public void SubmitForAdminTest()
        {
            ...
            var annTypeHw = SchoolTestContext.FirstTeacherSl.AnnouncementTypeService.GetAnnouncementTypeBySystemType(SystemAnnouncementType.Admin);
            var annDetails = annService.CreateAnnouncement(annTypeHw.Id);
            annDetails.Expires = SchoolTestContext.NowDate.AddDays(7);
        ...
        public void DeleteAnnouncementTest()
        {
            ...
            var type = SchoolTestContext.FirstTeacherSl.AnnouncementTypeService.GetAnnouncementTypeBySystemType(SystemAnnouncementType.HW);
