...
namespace Chalkable.Tests.Services.School
{
    public class FinalGradeServiceTest : BaseSchoolServiceTest
    {
        ...
        public void GetBuildFinalGradesTest()
        {
            ...
            var an1 = AnnouncementServiceTest.CreateDefaulTeacherAnnouncement(SchoolTestContext.FirstTeacherSl, mathClass1.Id, mpId);
        ...
        public void SetGetStudentFinalGradesTest()
        {
            ...
            finalGrade = SchoolTestContext.FirstTeacherSl.FinalGradeService.GetFinalGrade(mpc1.Id, true);
