...
namespace Chalkable.Tests.Services.School
{
    public class RoomServiceTest : BaseSchoolServiceTest
    {
        ...
        public void DeleteRoomWhereIsPersonTest()
        {
            ...
            var clPeriod = DistrictTestContext.DistrictLocatorFirstSchool.ClassPeriodService.Add(1, currentPeriod.Id, cl.Id, r1.Id, dayType.Id);
            ...
            DistrictTestContext.DistrictLocatorFirstSchool.ClassPeriodService.Delete(clPeriod.Id);
