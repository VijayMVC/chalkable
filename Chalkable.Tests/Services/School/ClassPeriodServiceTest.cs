...
namespace Chalkable.Tests.Services.School
{
    public class ClassPeriodServiceTest : BaseSchoolServiceTest
    {
        ...
        public void AddDeleteClassPeriodTest()
        {
            ...
            var clPeriodId = 1;
            AssertForDeny(sl => sl.ClassPeriodService.Add(clPeriodId, period1.Id, c1.Id, room1.Id, dt1.Id), FirstSchoolContext
            ...
            var cPeriod1 = cPeriodService.Add(clPeriodId, period1.Id, c1.Id, room1.Id, dt1.Id);
            ...
            clPeriodId++;
            AssertException<Exception>(() => cPeriodService.Add(clPeriodId, period1.Id, c2.Id, room1.Id, dt1.Id));
            AssertException<Exception>(() => cPeriodService.Add(clPeriodId, period1.Id, c1.Id, room2.Id, dt1.Id));
            district1Sl.ClassService.AddStudent(c2.Id, FirstSchoolContext.FirstStudent.Id);
            AssertException<Exception>(() => cPeriodService.Add(clPeriodId, period1.Id, c2.Id, room2.Id, dt1.Id));
            ...
            cPeriodService.Add(clPeriodId, period1.Id, c2.Id, room2.Id, dt1.Id);
            var period2 = district1Sl.PeriodService.Add(2, sy.Id, period1.EndTime + 10, period1.EndTime + 50, 2);
            //var period3 = district1Sl.PeriodService.Add(3, sy.Id, period1.StartTime, period1.EndTime, 3);
            clPeriodId++;
            cPeriodService.Add(clPeriodId, period2.Id, c2.Id, room1.Id, dt1.Id);
            ...
            clPeriodId++;
            var classPeriod1 = cPeriodService.Add(clPeriodId, period1.Id, c1.Id, room1.Id, dt3.Id);
            ...
            AssertForDeny(sl => sl.ClassPeriodService.Delete(classPeriod1.Id), FirstSchoolContext,
              SchoolContextRoles.AdminGrade | SchoolContextRoles.AdminEditor | SchoolContextRoles.AdminViewer
              | SchoolContextRoles.FirstTeacher | SchoolContextRoles.FirstStudent | SchoolContextRoles.FirstParent | SchoolContextRoles.Checkin);

            district1Sl.ClassPeriodService.Delete(classPeriod1.Id);
