...
namespace Chalkable.Tests.Sis
{
    public class StiApi : TestBase
    {
        ...
        public void SyncTest()
        {
            ...
            var cl = ConnectorLocator.Create("Chalkable", "yJ8bZ5nP1", "http://sandbox.sti-k12.com/Chalkable_Mobile/api/");
            ...
            var users = (cl.SyncConnector.GetDiff(typeof(User), null) as SyncResult<User>).All;
