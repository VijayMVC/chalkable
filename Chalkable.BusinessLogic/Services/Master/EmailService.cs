...
namespace Chalkable.BusinessLogic.Services.Master
{
    public interface IEmailService
    {
        ...
        void SendChangeEmailToDeveloper(Developer developer, string oldEmail, string newEmail);
    }
    ...
    public class EmailService : MasterServiceBase, IEmailService
    {
        ...
        {
            SendChangeEmailToUser(person.FirstName, oldEmail, newEmail);
        }

        public void SendChangeEmailToDeveloper(Developer developer, string oldEmail, string newEmail)
        {
            SendChangeEmailToUser(developer.DisplayName, oldEmail, newEmail);
        }
