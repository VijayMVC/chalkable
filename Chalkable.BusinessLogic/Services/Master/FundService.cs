...
namespace Chalkable.BusinessLogic.Services.Master
{
    ...
    public class FundService : MasterServiceBase, IFundService
    {
        ...
        private Fund Send(Guid schoolId, Guid? fromSchoolId, Guid? toSchoolId, Guid? fromUserId, Guid? toUserId, Guid? applicationInstallactionId, decimal amount, DateTime performedDateTime, string description)
        {
        ...
        public Fund AppInstallPersonPayment(Guid appInstallId, decimal amount, DateTime performedDateTime, string descrption)
        {
            if (!Context.SchoolId.HasValue)
                throw new UnassignedUserException();
            return Send(Context.SchoolId.Value, null, null, Context.UserId, null, appInstallId, amount, performedDateTime, descrption);
        }
