...
namespace Chalkable.BusinessLogic.Services.DemoSchool
{
    public class DemoAnnouncementService : DemoSchoolServiceBase, IAnnouncementService
    {
        ...
        public AnnouncementDetails EditAnnouncement(AnnouncementInfo announcement, int? classId = null)
        {
            ...
            var announcementStorage = CreateAnnouncementStorage(Context, Storage);
            var ann = announcementStorage.GetAnnouncement(announcement.AnnouncementId, Context.RoleId, Context.UserLocalId.Value);
            if (!AnnouncementSecurity.CanModifyAnnouncement(ann, Context))
                throw new ChalkableSecurityException();
            ...
            return announcementStorage.GetDetails(announcement.AnnouncementId, Context.UserLocalId.Value, Context.RoleId);
        }
        ...
        {
            return CreateAnnouncementStorage(Context, Storage).Exists(title, classId, expiresDate);
        }
