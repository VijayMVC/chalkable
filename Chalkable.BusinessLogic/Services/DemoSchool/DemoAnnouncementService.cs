...
//    public class DemoAnnouncementRecipientStorage : BaseDemoIntStorage<AnnouncementGroup>
//    {
...
//        public IList<AnnouncementGroup> GetList(int announcementId)
//        {
//            return data.Where(x => x.Value.AnnouncementRef == announcementId).Select(x => x.Value).ToList();
//        }

//        public IList<AnnouncementGroup> GetList(int announcementId, int? roleId, int? personId, bool toAll = false)
//        {
//            //TODO rewrites impl
...
//        public IList<AnnouncementGroup> GetAnnouncementRecipients(int announcementId, int? roleId, int? personId, bool toAll = false)
//        {
//            return AnnouncementRecipientStorage.GetList(announcementId, roleId, personId, toAll);
//        }

//        public IList<AnnouncementGroup> GetAnnouncementRecipients(int? announcementId)
//        {
...
//        public AnnouncementDetails EditAnnouncement(ClassAnnouncementInfo announcement, int? classId = null, IList<int> groupsIds = null)
//        {
...
//                storage.Add(groupsIds.Select(x => new AnnouncementGroup
//                    {
