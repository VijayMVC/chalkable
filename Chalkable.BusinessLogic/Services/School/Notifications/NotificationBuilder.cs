...
namespace Chalkable.BusinessLogic.Services.School.Notifications
{
    public class NotificationBuilder
    {
        ...
        public Notification BuildAnnouncementQnToAuthorNotifiaction(AnnouncementQnAComplex announcementQnA, AnnouncementComplex announcement, Person recipient)
        {
        ...
        public Notification BuildAnnouncementAnswerToPersonNotifiaction(AnnouncementQnAComplex announcementQnA, AnnouncementComplex announcement, Person fromSchoolPerson)
        {
