...
namespace Chalkable.BusinessLogic.Services.School
{
    ...
    public class FinalGradeService : SchoolServiceBase, IFinalGradeService
    {
        ...
        public FinalGradeDetails Update(Guid id, int participation, int attendance, bool dropLowestAttendance, int disipline, bool dropLowestDiscipline, GradingStyleEnum gradingStyle, IList<FinalGradeAnnouncementType> byType)
        {
            throw new NotImplementedException();
        }
