...
namespace Chalkable.BusinessLogic.Model
{
    public class StudentSummeryInfo
    {
        ...
        public DailyAbsenceSummaryInfo DailyAbsence { get; set; }
        public int TotalDisciplineOccurrences { get; set; }
        public IList<InfractionSummaryInfo> InfractionSummaries { get; set; }
        public IList<ShortGradeInfo> StudentAnnouncements { get; set; }
            ...
            var res = new StudentSummeryInfo
                {
                    ...
                    DailyAbsence = DailyAbsenceSummaryInfo.Create(nowDashboard.DailyAttendance),
