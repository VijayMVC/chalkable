...
namespace Chalkable.BusinessLogic.Model
{
    public class BaseApplicationInfo
    {
        ...
        public static BaseApplicationInfo Create(ShortApplicationInfo shortApplicationInfo, Guid developerId,
            ...
            IList<Guid> categories = null, ApplicationAccessInfo applicationAccess = null, IList<int> gradeLevels = null)
        {
    ...
    public class ShortApplicationInfo
    {
        ...
        public static ShortApplicationInfo Create(string name, string url, string shortDescription, string description, string videoDemoUrl,
                             Guid? smallPictureId, Guid? bigPictureId, IList<AppPermissionType> permissionIds)
        {
