...
namespace Chalkable.StiConnector.Connectors
{
    public class ActivityAttachmentsConnector : ConnectorBase
    {
        ...
        {
            return PostWithFile<IList<ActivityAttachment>>(string.Format(url_format, activityId), fileName, fileContent);
        }
        ...
        {
            PostWithFile<ActivityAttachment>(string.Format(url_format + "/{1}", activityId, id), fileName, fileContent, PUT);
        }
