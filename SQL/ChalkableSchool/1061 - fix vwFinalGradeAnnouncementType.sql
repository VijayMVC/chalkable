alter view [dbo].[vwFinalGradeAnnouncementType]
as 
select 
	 ...
	 AnnouncementType.Id as AnnouncementType_Id,
	 AnnouncementType.Name as AnnouncementType_Name,
	 AnnouncementType.IsSystem as AnnouncementType_IsSystem,
	 AnnouncementType.[Description] as AnnouncementType_Description,
	 AnnouncementType.Gradable as AnnouncementType_Gradable	
...
alter procedure [dbo].[spGetFinalGrades] @finalGradeId uniqueidentifier, @callerId uniqueidentifier, @callerRoleId int
...
alter procedure [dbo].[spBuildFinalGrade] @markingPeriodClassId uniqueidentifier, @callerId uniqueidentifier, @callerRoleId int
as
