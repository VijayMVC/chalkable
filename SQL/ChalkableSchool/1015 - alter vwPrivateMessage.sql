...
AS
	SELECT
		 ...
		 sp.SchoolRef as PrivateMessage_SenderSchoolRef,
		 ...
		 sp2.SchoolRef as PrivateMessage_RecipientSchoolRef,
	...
	FROM 
		...
		join SchoolPerson sp2 on sp2.PersonRef = p2.Id and sp.SchoolRef = sp2.SchoolRef
GO
