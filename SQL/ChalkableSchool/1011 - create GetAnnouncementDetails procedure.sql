...
as
	...
	select vwPerson.*,
		   StudentAnnouncement.*, 
		   ClassPerson.ClassRef as ClassId
	...
	where AnnouncementRef = @announcementId and Announcement.[State] = 1
	and (ClassPerson.PersonRef = @personId or @roleId = 2 or @roleId = 5 or @roleId = 8 or @roleId = 7)

GO

create procedure [dbo].[spGetAnnouncementDetails] @id uniqueIdentifier, @callerId uniqueIdentifier
as
