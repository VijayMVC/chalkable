...
begin
     insert into AnnouncementRecipientData(Id, AnnouncementRef, PersonRef, Starred, StarredAutomatically)
     values (NewId(), @announcementId, @personId, @starred, @starredAutomatically)
end
GO
