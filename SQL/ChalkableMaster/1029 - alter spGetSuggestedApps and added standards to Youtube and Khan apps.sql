...
insert into ApplicationStandard
select a.Id, ccs.Id  from Application a
cross join CommonCoreStandard ccs
where (a.Name like '%Youtube%' or a.Name like '%Khan%') 
	and ccs.ParentStandardRef is null
	and not exists(select * from ApplicationStandard where ApplicationStandard.ApplicationRef = a.Id 
