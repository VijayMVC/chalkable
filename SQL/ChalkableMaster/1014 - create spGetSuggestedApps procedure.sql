create procedure spGetSuggestedApplications @standardsCodes nvarchar(max), @installedAppsIds nvarchar(max), @start int, @count int
as
...
if @installedAppsIds is not null
begin
