...
namespace Chalkable.StiImport.Services
{
    public partial class ImportService
    {
        ...
        {
            List<Expression<Action>> updates = new List<Expression<Action>>();
            
            updates.Add(() => UpdateSchools());
            updates.Add(() => UpdateAddresses());
            updates.Add(() => UpdateUsers());
            updates.Add(() => UpdatePersons());
            updates.Add(() => UpdateStaff());
            updates.Add(() => UpdateStudent());
            updates.Add(() => UpdateStudentSchool());
            updates.Add(() => UpdatePersonsEmails());
            updates.Add(() => UpdatePhones());
            updates.Add(() => UpdateGradeLevels());
            updates.Add(() => UpdateSchoolYears());
            updates.Add(() => UpdateStudentSchoolYears());
            updates.Add(() => UpdateMarkingPeriods());
            updates.Add(() => UpdateGradingPeriods());
            updates.Add(() => UpdateDayTypes());
            updates.Add(() => UpdateBellSchedules());
            updates.Add(() => UpdateDays());
            updates.Add(() => UpdateRooms());
            updates.Add(() => UpdateGradingScales());
            updates.Add(() => UpdateCourseTypes());
            updates.Add(() => UpdateCourses());
            updates.Add(() => UpdateClassTeachers());
            updates.Add(() => UpdateStandardSubject());
            updates.Add(() => UpdateStandards());
            updates.Add(() => UpdateClassStandard());
            updates.Add(() => UpdateMarkingPeriodClasses());
            updates.Add(() => UpdatePeriods());
            updates.Add(() => UpdateScheduledTimeSlots());
            updates.Add(() => UpdateScheduledTimeSlotVariations());
            updates.Add(() => UpdateClassPersons());
            updates.Add(() => UpdateAttendanceReasons());
            updates.Add(() => UpdateAttendanceLevelReasons());
            updates.Add(() => UpdateAlphaGrades());
            updates.Add(() => UpdateAlternateScores());
            updates.Add(() => UpdateInfractions());
            updates.Add(() => UpdateGradingScaleRanges());
            updates.Add(() => UpdateClassroomOptions());
            updates.Add(() => UpdateGradingComments());
            updates.Add(() => UpdateSchoolsOptions());
            updates.Add(() => UpdateAttendanceMonthes());
            updates.Add(() => UpdateGradedItems());
            updates.Add(() => UpdateAnnouncementAttribues());
            updates.Add(() => UpdateContactRelationships());
            updates.Add(() => UpdateStudentContacts());
            updates.Add(() => UpdateSystemSettings());

            ProcessActions(updates, "Update");            
        }
