...
namespace Chalkable.UserTracking
{
    ...
    {
        void InvitedUser(string email, string inviteEmail, string firstName, string lastName, string school, string role);
        ...
        void IdentifySignUpUser(string email, string username, string schoolName, 
            DateTime firstLoginDate, string timeZoneId, string role, string ip);
