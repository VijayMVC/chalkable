...
namespace Chalkable.Web.Models.AnnouncementsViewData
{
    public class AnnouncementPeriodViewData
    {
        ...
        public static AnnouncementPeriodViewData Create(ScheduleItem scheduleItem, IList<AnnouncementComplex> announcements, DateTime nowSchoolTime)
        {
            var periodVd = ScheduleItemViewData.Create(scheduleItem, nowSchoolTime);
        ...
        public static IList<AnnouncementPeriodViewData> Create(IList<ScheduleItem> schedule, IList<AnnouncementComplex> announcements, DateTime nowSchoolTime)
        {
            ...
            foreach (var scheduleItem in schedule)
            {
                ...
                res.Add(Create(scheduleItem, annItems, nowSchoolTime));
            }
            return res;
        }
    }
