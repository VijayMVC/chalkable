...
;;(function(jQuery, jade) {
    ...
    __ASSETS._trzyxk3vtpzj8aor = function anonymous(locals) {
        var buf = [];
        var self = locals || {};
    ...
    __ASSETS._lwzoran4r8gp66r = function anonymous(locals) {
        var buf = [];
        var self = locals || {};
    ...
    __ASSETS._jprdx4btrdjnstt9 = function anonymous(locals) {
        var buf = [];
        var self = locals || {};
    ...
    (function() {
        ...
        (function() {
            chlk.templates.developer.DeveloperDocs = function ClassCompilerImpl() {
                ...
                return ria.__SYNTAX.compileClass(name, def);
            }([ ria.templates.TemplateBind("_jprdx4btrdjnstt9") ], [ ria.templates.ModelBind(chlk.models.developer.DeveloperDocs) ], "DeveloperDocs", ria.__SYNTAX.EXTENDS(chlk.templates.JadeTemplate), [ [ ria.templates.ModelPropertyBind ], String, "docsUrl" ]);
        })();
    })();
    "chlk.activities.lib.TemplatePage";
    ...
    __ASSETS._g5kgj4zvq4yam7vi = function anonymous(locals) {
        var buf = [];
        var self = locals || {};
    ...
    (function() {
        ...
        (function() {
            chlk.DeveloperApp = function ClassCompilerImpl() {
                ...
                return BASE().then(function(data) {
                    new ria.dom.Dom().fromHTML(ASSET("_trzyxk3vtpzj8aor")()).appendTo("#sidebar");
                    return data;
                });
            } ]);
        })();
