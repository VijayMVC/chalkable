...
NAMESPACE('chlk.services', function () {
    ...
    CLASS(
        'GradingService', EXTENDS(chlk.services.BaseService), [
            ...
            [[chlk.models.id.ClassId, chlk.models.id.SchoolPersonId, chlk.models.id.GradingPeriodId, Number, String, Boolean, Object]],
            ria.async.Future, function updateStudentAverage(classId, studentId, gradingPeriodId, averageId, averageValue, exempt_, codes) {
            ...
            [[chlk.models.id.ClassId, chlk.models.id.SchoolPersonId, chlk.models.id.GradingPeriodId, Number, String, Boolean, Object]],
            ria.async.Future, function updateStudentAverageFromFinalPage(classId, studentId, gradingPeriodId, averageId, averageValue, exempt_, codes) {
                var res =  this.updateStudentAverage(classId, studentId, gradingPeriodId, averageId, averageValue, exempt_, codes)
                    .then(function(model){
