    ...
    CLASS(
        'BaseApp', EXTENDS(ria.mvc.DefaultApplication), [
            ...
            OVERRIDE, ria.mvc.ISession, function initSession_() {
                ...
                this.saveInSession(session, ChlkSessionConstants.SCHOOL_YEAR, chlk.models.schoolYear.Year, null, ['data']);
                ...
                this.saveInSession(session, ChlkSessionConstants.SCHOOL_YEAR, chlk.models.id.SchoolYearId, ChlkSessionConstants.CURRENT_SCHOOL_YEAR_ID, ['data', 'id']);
