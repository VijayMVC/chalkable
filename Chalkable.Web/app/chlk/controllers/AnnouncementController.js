...
NAMESPACE('chlk.controllers', function (){
    ...
    CLASS(
        ...
        function askQuestionAction(model) {
            this.announcementService.askQuestion(model.getAnnouncementId(), model.getQuestion());
        },

        [[chlk.models.announcement.QnAForm]],
        function answerQuestionAction(model) {
            this.announcementService.answerQuestion(model.getId(), model.getQuestion(), model.getAnswer());
        }
    ])
});
