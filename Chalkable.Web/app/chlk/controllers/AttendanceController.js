    ...
    CLASS(
        ...
        function summaryAdminAction(update_, gradeLevels_) {
            ...
            var res = this.attendanceService
                .getAdminAttendanceSummary(true, true, true, gradeLevels_, null, markingPeriod.getId(), markingPeriod.getId())
                .attach(this.validateResponse_())
                .then(function(model){
            ...
            return this[update_ ? 'UpdateView' : 'PushView'](chlk.activities.attendance.AdminAttendanceSummaryPage, res);
        },
