...
NAMESPACE('chlk.controllers', function (){
    ...
    CLASS(
        'StudentsController', EXTENDS(chlk.controllers.BaseController), [
            ...
            chlk.models.common.PaginatedList, function prepareUsers(usersData){
            ...
            function updateListAction(model){
                ...
                var isScroll = submitType == "scroll";
                var result = this.studentService.getStudents(model.getClassId(), model.getFilter(), model.isMy(), model.isByLastName(), model.getStart(), 10)
                    .then(function(usersData){
                        if(isScroll){
                            usersData = this.prepareUsers(usersData);
                            return usersData.getItems();
                        }else{
                ...
                return this.UpdateView(chlk.activities.person.ListPage, result);
            },
