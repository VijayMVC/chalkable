...
REQUIRE('chlk.templates.district.SchoolsStatisticTpl');
...
NAMESPACE('chlk.activities.district', function () {
    ...
    CLASS(
        ...
        [ria.mvc.PartialUpdateRule(chlk.templates.district.SchoolsStatisticTpl, '', '.grid-container', ria.mvc.PartialUpdateRuleActions.Replace)],
