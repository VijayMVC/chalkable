...
REQUIRE('chlk.templates.grading.TeacherSettings');
REQUIRE('chlk.templates.grading.Final');

NAMESPACE('chlk.activities.grading', function () {

    /** @class chlk.activities.grading.TeacherSettingsPage */
    CLASS(
        ...
        [ria.mvc.TemplateBind(chlk.templates.grading.TeacherSettings)],
