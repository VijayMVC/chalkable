...
REQUIRE('chlk.templates.classes.grading.ClassProfileGradingStandardsGridTpl');
...
NAMESPACE('chlk.activities.classes.grading', function () {
    ...
    CLASS(
        ...
        [ria.mvc.TemplateBind(chlk.templates.classes.grading.ClassProfileGradingStandardsGridTpl)],
