...
REQUIRE('chlk.templates.discipline.DisciplinePopupTpl');

NAMESPACE('chlk.activities.discipline', function(){

    /** @class chlk.activities.discipline.DayDisciplinePopup */
    ...
    CLASS(
        ...
        [ria.mvc.TemplateBind(chlk.templates.discipline.DisciplinePopupTpl)],

        'DayDisciplinePopup', EXTENDS(chlk.activities.lib.TemplatePopup),[
