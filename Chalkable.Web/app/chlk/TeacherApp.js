...
REQUIRE('chlk.controllers.announcement.ClassAnnouncementController');
REQUIRE('chlk.controllers.announcement.LessonPlanController');
REQUIRE('chlk.controllers.announcement.SupplementalAnnouncementController');
