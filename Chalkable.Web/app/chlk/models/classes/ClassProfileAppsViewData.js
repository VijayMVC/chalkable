...
NAMESPACE('chlk.models.classes', function(){
    ...
    CLASS('ClassProfileAppsViewData', EXTENDS(chlk.models.classes.BaseClassProfileViewData), [
        ...
        [[chlk.models.common.Role, chlk.models.classes.ClassApps, ArrayOf(chlk.models.people.Claim), Boolean]],
        function $(role_, classApps_, claims_, isAssignedToClass_){
            BASE(role_, classApps_, claims_, isAssignedToClass_);
        }
    ]);
});