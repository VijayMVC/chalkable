    ...
    CLASS(
        'UsersList', EXTENDS(chlk.models.people.UsersListSubmit),[
            ...
            [[chlk.models.common.PaginatedList, Boolean, Number,  String
                , Number, chlk.models.common.Role, chlk.models.people.User, String, Boolean, Boolean]],
            function $(users_, byLastName_, selectedIndex_,  filter_, start_, currentUserRole_, currentUser_, rolesText_, hasAccess_, messagingDisabled_){
                BASE();
                if(users_)
                ...
                if(messagingDisabled_)
                    this.setMessagingDisabled(messagingDisabled_);
            }
        ]);
});
