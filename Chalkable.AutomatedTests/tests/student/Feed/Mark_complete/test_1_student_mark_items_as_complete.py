...
class TestMarkActivitiesAsComplete(BaseTestCase):
    def setUp(self):
    ...
    def internal_(self, announcement_type):
        ...
        feed_list1 = self.student.post_json('/Feed/List.json', data={
            'classId': '',
            'complete': 'False',
            'count': 10,
            'start': 0
        ...
        if len(feed_list1['data']['annoucementviewdatas']) != 0:
            ...
            # posting complete
            self.student.post_json('/Announcement/Complete', data={
            ...
            # get all activities/supplementals/lesson plans
            feed_list2 = self.student.post_json('/Feed/List.json', data={'classId': '', 'count': 10, 'start': 0})

            self.assertTrue(feed_list2['data']['annoucementviewdatas'][0]['complete'],
                            'Item was not marked as done')
