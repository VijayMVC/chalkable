            ...
            for item in list_items_json_unicode(0, 2500):
                if self.current_time > self.current_date_plus_10:
                    ...
                    if item['type'] == 1 or item['type'] == 4:
                        self.assertTrue(
                            (get_item_date(item) < self.current_date_minus_10) or (
                ...
                if (self.current_time >= self.current_date_minus_10) and (
                    self.current_time <= self.current_date_plus_10):
                    self.assertFalse(item['complete'], "Verify item's state on false")
            ...
            for item in list_items_json_unicode(0, 2500):
                if self.current_time > self.current_date_plus_10:
                    ...
                    if item['type'] == 1 or item['type'] == 4:
                        self.assertTrue(
                            (get_item_date(item) < self.current_date_minus_10) or (
                            get_item_date(item) > self.current_date_plus_10) or (
                            get_item_date(item) >= self.current_date_minus_10 and get_item_date(
