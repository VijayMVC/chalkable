...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        # marking items as 'Older than 30 days'
        self.settings_data_2 = {'option': '2'}
    ...
    def do_feed_list_and_verify(self, start, count=2500):
        ...
        for item in dictionary_verify_annoucementviewdatas_all:
            self.assertTrue((get_item_date(item) >= self.current_date_minus_30),'This admin announcement was not marked as complete ' + str(item["id"]) + " " + str(get_item_date(item)))
