...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        self.get_file_admin('/Reporting/FeedReport.json?' + 'startDate=' + str(start_date_correct_format) + '&endDate=' + str(end_date_correct_format) + '&lessonPlanOnly=' + str(False) + '&includeAttachments=' + str(False) + '&includeDetails=' + str(True) + '&includeHiddenAttributes=' + str(False) + '&includeHiddenActivities=' + str(False) + '&classId=' + '&complete=' + str(False) + '&announcementType=')
