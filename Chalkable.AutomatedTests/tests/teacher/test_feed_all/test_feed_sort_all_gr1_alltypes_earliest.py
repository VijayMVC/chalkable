# Feed > All. ["Gr 1","All Types","Earliest"]
...
class TestFeed(BaseAuthedTestCase):
    ...
    def do_feed_list_and_verify(self, start, count=750):
        ...
        self.assertDictContainsSubset(self.settings_data, {'sortType':sorttype, 'gradingPeriodId':gradingperiodid}, 'key/value pair exists')
