# Feed > All. ["Custom Range", "Activities Only", "Latest"]
...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        self.settings_data = {'announcementType':'1', 'sortType':'1', 'fromDate': self.current_date_minus_10, 'toDate':self.current_date_plus_10}
