...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        done_lesson_plans = self.get('/Feed/List.json?start='+str(0)+'&classId=&complete=true&count='+str(2000))
        ...
        done_lesson_plans_2 = self.get('/Feed/List.json?start='+str(0)+'&classId=&complete=true&count='+str(2000))
        ...
        done_items = self.get('/Feed/List.json?start='+str(0)+'&classId=&complete=true&count='+str(2000))
        ...
        done_items_2 = self.get('/Feed/List.json?start='+str(0)+'&classId=&complete=true&count='+str(2000))
            ...
            for item in dictionary_verify_annoucementviewdatas_all:
                ...
                if type == '1':
                    ...
                    for key2, value2 in classannouncementdata.iteritems():
                        ...
                        self.assertTrue(self.current_date_minus_30 <= expiresdate, 'Current date > expiresdate of an activity')
        else:
