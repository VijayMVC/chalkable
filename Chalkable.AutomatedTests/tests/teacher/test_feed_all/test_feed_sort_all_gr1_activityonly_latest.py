# Feed > All. "Gr 1","Activity Only","Earliest"]
...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        #set filter for activity + Gr1
        self.settings_data = {'announcementType':'1', 'sortType':'1', 'gradingPeriodId': self.gr_periods()[0]}
    ...
    def do_feed_list_and_verify(self, start, count=500):
        ...
        self.assertTrue(gradingperiodid == self.gr_periods()[0], "Verify item on grading period")
        
        list_for_date = []
        
        #verify that only activities for S1 are shown
