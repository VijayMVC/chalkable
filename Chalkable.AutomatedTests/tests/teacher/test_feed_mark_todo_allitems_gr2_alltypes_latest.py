            ...
            for item in dictionary_verify_annoucementviewdatas_all:
                ...
                if type == '3':
                    ...
                    for key, value in lessonplandata.iteritems():
                        ...
                        self.assertTrue((startdate < decoded_list_1[1]) or (startdate > decoded_list_2[1]), 'Verify expiresdate of activity ' + str(item["id"]))
                if type == '1':
                    ...
                    for key2, value2 in classannouncementdata.iteritems():
                        ...
                        self.assertTrue((expiresdate < decoded_list_1[1]) or (expiresdate > decoded_list_2[1]), 'Verify expiresdate of activity ' + str(item["id"]))
