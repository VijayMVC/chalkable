...
class TestFeed(BaseAuthedTestCase):
    ...
    def test_people_student_sorting_by_last_name(self):
    ...
    def do_student_sorting_lastname(self, start, count = 1000):
        ...
        get_needed_page = self.get('/Student/GetStudents.json?myStudentsOnly=true&byLastName=true&start='+str(start)+'&count='+str(count))
        ...
        get_filtered_page = self.get('/Student/GetStudents.json?classId=&filter='+str(only_one_student)+'&myStudentsOnly=true&byLastName=true&start='+str(start)+'&count='+str(count))
