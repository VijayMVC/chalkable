    ...
    def internal_(self):
        ...
        for i in range(3):
            post_send = self.teacher.post_json('/PrivateMessage/Send.json',
                                               data={"body": "this is a body_message_for_own_class",
                                                     "classId": 13861,
                                                     "subject": "this is a subject_message_for_own_class"})
        ...
        for i in self.student_get_all_inbox_messages():
            self.assertTrue(i['incomemessagedata']['body'] == "this is a body_message_for_own_class", 'body of the message is equal')
            self.assertTrue(i['incomemessagedata']['subject'] == "this is a subject_message_for_own_class", 'subject of the message is equal')
