    ...
    def test_feed(self):
        ...
        for one_class in list_for_class_id:
            if one_class == 13861 or one_class == 13806 or one_class == 14011 or one_class == 14436:
                ...
                for i in class_summary_grids['data']['currentgradingbox']['byannouncementtypes']:
                    for k in i['announcements']:
                        list_for_activity_id.append(k['id'])

                self.get('/Grading/ItemGradingStat?' + 'announcementId=' + str(random.choice(list_for_activity_id)))
