...
class TestAllTypesOfItemsByGradingPeriods(BaseTestCase):
    ...
    def test_items_first_gr_period(self):
        self.internal_(self.teacher.gr_periods()[0], self.decoded_list_1[0], self.decoded_list_2[0])

    def test_items_second_gr_periods(self):
        self.internal_(self.teacher.gr_periods()[1], self.decoded_list_1[1], self.decoded_list_2[1])
