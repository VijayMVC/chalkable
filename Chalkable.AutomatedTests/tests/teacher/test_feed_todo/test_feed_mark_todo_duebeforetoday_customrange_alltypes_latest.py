# Feed > ToDo. ["Items due before today", Custome Range", "All Types", "Latest"]
...
#########################################################################################################################
        ...
        self.settings_data = {'sortType':'1', 'fromDate': self.current_date_minus_10, 'toDate':self.current_date_plus_10}
    ...
    def do_feed_list_and_verify(self, start, count=2000):
        ...
        fromdate = dictionary_verify_settingsforfeed['fromdate']
        todate = dictionary_verify_settingsforfeed['todate']
