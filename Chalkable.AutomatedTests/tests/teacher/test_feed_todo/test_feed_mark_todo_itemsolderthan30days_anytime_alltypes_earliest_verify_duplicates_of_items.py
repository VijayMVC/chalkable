...
#########################################################################################################################
        ...
        set_of_id_gr1 = set(self.id_of_lessonplan_and_activities_gradingperiod1)
        list_of_id_gr1 = list(set_of_id_gr1)
        
        set_of_id_gr2 = set(self.id_of_lessonplan_and_activities_gradingperiod2)
        list_of_id_gr2 = list(set_of_id_gr2)
        
        self.assertItemsEqual(self.id_of_lessonplan_and_activities_gradingperiod2, list_of_id_gr2, 'two lists are not equal in gr2')
        self.assertItemsEqual(self.id_of_lessonplan_and_activities_gradingperiod1, list_of_id_gr1, 'two lists are not equal in gr1')
