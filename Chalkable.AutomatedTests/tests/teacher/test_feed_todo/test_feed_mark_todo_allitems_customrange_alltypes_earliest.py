            ...
            for item in dictionary_verify_annoucementviewdatas_all:
                ...
                if type == '3':
                    ...
                    for key, value in lessonplandata.iteritems():
                        ...
                        self.assertTrue((startdate < self.current_date_minus_10) or (startdate > self.current_date_plus_10), 'Verify expiresdate of lesson plan ' + str(item["id"]))
                if type == '1':
                    ...
                    for key2, value2 in classannouncementdata.iteritems():
                        ...
                        self.assertTrue((expiresdate < self.current_date_minus_10) or (expiresdate > self.current_date_plus_10), 'Verify expiresdate of activity ' + str(item["id"]))
