# Feed > ToDo. ["Items due before today", Custom Range", "Activities Only", "Latest"]
...
#########################################################################################################################
        ...
        self.settings_data = {'sortType':'1', 'announcementType':'1', 'fromDate': self.current_date_minus_10, 'toDate':self.current_date_plus_10}
        self.post('/Feed/SetSettings.json?', self.settings_data) 
        
        #get items 'Due before today'
        self.settings_data_2 = {'option':'1', 'annType':'1'}
