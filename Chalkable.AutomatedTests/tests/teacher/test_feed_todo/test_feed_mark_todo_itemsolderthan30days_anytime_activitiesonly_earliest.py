...
class TestFeed(BaseAuthedTestCase):
    def test_feed(self):
        ...
        #not needed now annoucementviewdatas_json_unicode = done_lesson_plans_json_unicode['data']['annoucementviewdatas']
        ...
        #not needed now annoucementviewdatas_json_unicode_2 = done_lesson_plans_json_unicode_2['data']['annoucementviewdatas']       
...
#########################################################################################################################
        ...
        #not needed now for_item_id_1 = done_activities_json_unicode['data']['annoucementviewdatas']        
        ...
        #not needed now for_item_id_2 = done_activities_json_unicode_2['data']['annoucementviewdatas']        
