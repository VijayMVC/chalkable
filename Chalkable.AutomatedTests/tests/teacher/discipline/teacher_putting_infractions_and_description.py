                    ...
                    if len(get_class_list['data']) > 0:
                        ...
                        for info_about_one_student in json_data_get_class_list_second_time:
                            if info_about_one_student['studentid'] == studentid:
                                self.assertEquals(info_about_one_student['description'], "testing",
                                                  'discipline description are equal' + " " + str(
                                                      info_about_one_student['description']) + " " + str(info_about_one_student['description']) + " " + str(
                                                      studentid))
